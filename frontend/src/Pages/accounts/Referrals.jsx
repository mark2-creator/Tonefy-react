...
const Referrals = () => {
  ...
  return (
    ...
    <DashboardHeader/>
    <AccountsSidebar/>
    <div className="ml-36 mt-16 px-6 py-10 bg-gray-300 rounded-md shadow-md min-h-screen w-[1100px] space-y-6">
      
      <h1 className="text-3xl font-bold text-[#2ecc71] mb-2">Referrals</h1>
