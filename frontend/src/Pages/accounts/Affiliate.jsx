...
<DashboardHeader/>
<AccountsSidebar/>
 <div className="ml-36 mt-16 px-6 py-10 bg-gray-300 rounded-md shadow-md min-h-screen mx-auto space-y-6">
      <h2 className="text-3xl font-bold text-[#2ecc71] mb-4 px-6">
      ...
      <div className="px-6 mb-6">
        <button className="bg-[#2ecc71] text-[#2ecc71] font-semibold py-2 px-6 rounded hover:bg-[#27ae60] transition">
          Join the program
        </button>
      </div>
